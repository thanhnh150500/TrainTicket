...
<html lang="vi">
    ...
    <body class="p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3>Danh sách ga</h3>
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/manager/stations?op=new">
                <i class="bi bi-plus"></i> Thêm ga
            </a>
        </div>
        ...
        <table class="table table-striped align-middle">
            <thead>
                <tr>
                    ...
                    <th style="width:260px;">Tên ga</th>
                    <th>Địa chỉ</th>
                    <th style="width:220px;">Thành phố</th>
                ...
                <c:forEach items="${list}" var="s">
                    <tr>
                        ...
                        <td class="d-flex gap-2">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/manager/stations" class="d-inline">
                                <input type="hidden" name="op" value="delete"/>
                                <input type="hidden" name="id" value="${s.stationId}"/>
                                <input type="hidden" name="_csrf" value="${sessionScope.csrfToken}"/>
                                <button type="submit" class="btn btn-sm btn-outline-danger"
                                        onclick="return confirm('Xóa ga này?');">Xóa</button>
                            </form>
                        </td>
                    </tr>
                </c:forEach>
                <c:if test="${empty list}">
                    <tr><td colspan="6" class="text-center text-muted">Chưa có ga nào.</td></tr>
                </c:if>
            </tbody>
        </table>
