            ...
            <tbody>
                <c:forEach items="${list}" var="x">
                    <tr>
                        <td>${x.fareRuleId}</td>
                        <td>
                            <c:out value="${x.routeCode}"/> —
                            <c:out value="${x.originName}"/> → <c:out value="${x.destName}"/>
                        </td>
                        <td>
                            <c:out value="${x.seatClassName}"/> <small class="text-muted">(<c:out value="${x.seatClassCode}"/>)</small>
                        </td>
                        <td><c:out value="${x.basePrice}"/></td>
                        <td>
