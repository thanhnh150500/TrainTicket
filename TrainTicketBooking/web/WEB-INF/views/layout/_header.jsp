...
<c:url var="bookingHistoryUrl" value="/booking-history" />
<c:url var="loginForHistoryUrl" value="/auth/login"><c:param name="next" value="/booking-history" /></c:url>
<c:url var="checkTicketUrl" value="/booking/detail" />
<c:url var="loginForHistoryUrl" value="/auth/login"><c:param name="next" value="/booking/detail" /></c:url>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ttNavbar">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link
                       ${ fn:startsWith(path, '/booking-history') or fn:startsWith(path, '/booking/detail') ? 'active' : '' }"
                       href="${ empty sessionScope.authUser ? loginForHistoryUrl : bookingHistoryUrl }">
                        Thông tin đặt chỗ
                    </a>
                </li>
