    ...
    <body class="bg-light">
        ...
        <div class="container py-3">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="vr"></div>
                    <div class="text-secondary">1 khách</div>
                </div>
            ...
            <!-- Dải ngày (tự render từ searchDate, không phụ thuộc 'days') -->
            <div class="card-body pt-2 pb-0">
                ...
                <div class="days-strip d-flex flex-nowrap gap-3 overflow-auto pb-2">
                    <%
                      ...
                      // ==== Suy ra prefix URL "...&date=" từ prev/next ====
        ...
        <c:choose>
            <c:when test="${empty trips}">
                <div class="alert alert-warning">Không có chuyến cho ngày này.</div>
            </c:when>
            <c:otherwise>
                <div class="vstack gap-3">
                    <c:forEach var="t" items="${trips}">

                        <%-- TÍNH HH:mm AN TOÀN (scriptlet thường, không dùng <%= ... %> để khai báo) --%>
                        <%
                                    ...
                                    <div class="col-md-5">
                                        <div class="row text-center align-items-center">
                                            <div class="col-5">
                                                ...
                                                <div class="small text-muted">Ga Hà Nội</div>
                                            </div>
                                            <div class="col-2">
                                                <div class="duration">
                                                    <i class="bi bi-arrow-right-short"></i>
                                                    ${t.durationMin div 60}h
                                                    ${t.durationMin mod 60 < 10 ? '0' : ''}${t.durationMin mod 60}p
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="time-lg"><%= hhmmArr %></div>
                                                <div class="small text-muted">Ga Đà Nẵng</div>
                                            </div>
                                        </div>
                                    </div>
