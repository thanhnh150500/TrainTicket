...
public class TrainDao {
    ...
    // vn/ttapp/dao/TrainDao.java (bổ sung)
    ...
    // ====== META STRUCTS (đầy đủ thông tin đoàn tàu) ======
    // trong TrainDao
    ...
    /**
     * Trả về thông tin đoàn tàu đầy đủ: - Tàu: id, code, name - Danh sách toa
     * (carriage): code, sortOrder, seatClass (code/name), seatCount - Toàn bộ
     * ghế của các toa: code, positionInfo, seatClass (code/name) - Tổng số toa
     * / tổng số ghế
     */
