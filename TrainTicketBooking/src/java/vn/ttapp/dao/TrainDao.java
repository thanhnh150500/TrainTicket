...
public class TrainDao {
    ...
    // ========== WRITE ==========
    /**
     * Tạo mới và trả về ID vừa tạo (SQL Server, IDENTITY).
     */
    public Integer create(String code, String name) throws SQLException {
        ...
        try (Connection c = Db.getConnection(); PreparedStatement ps = c.prepareStatement(sql)) {
            ps.setString(1, code);
            // name thường là NVARCHAR -> dùng setNString để chuẩn Unicode
    ...
    public int delete(int id) throws SQLException {
        ...
        // ... các CRUD findById/findAll/... như bạn đã có ...
        ...
        public static class SeatMeta {
            ...
            public String positionInfo; // ví dụ: "Dãy A", "Tầng trên"...
        }
        ...
        /**
         * Trả về Train + mỗi Toa + toàn bộ Ghế.
         */
